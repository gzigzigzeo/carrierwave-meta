...
If you want to use plugin with PDF/PostScript files than you should:

1. Use RMagick as processor for PDF/PostScript uploader.
1. Install GhostScript.
1. Build ImageMagick with GhostScript support.
...
@fschwahn added support for mini-magick. To run tests with mini-magick do:
  ...
  PROCESSOR=mini_magick bundle exec rake spec

@skord added support for ImageSorcery. To run specs do:

  PROCESSOR=image_sorcery bundle exec rspec

@SergeyKishenin added support for EPS/GhostScript files.
